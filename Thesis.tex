...
\input{Chapters/2_Background_theory} % Background Theory 

\input{Chapters/3_Development_method} % Development Method

\input{Chapters/4_Implementation} % Implementation

\input{Chapters/5_Results} % Results

\input{Chapters/6_Discussion} % Discussion

\input{Chapters/7_Conclusion} % Conclusion

\input{Chapters/8_Bibliography} % Bibliography
...
\input{Appendices/A} % SIA Implementation code

\input{Appendices/B} % MIA Implementation code

\input{Appendices/C} % Prediction System Implementation code
